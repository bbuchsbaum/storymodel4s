...
repo=Path('/private/tmp/storymodel4s-d1a-s4b-20260919');out=Path('/Users/bbuchsbaum/code/scala/storymodel4s/data/study/d1a-s4b-20260919')
...
cmd=['sbt','-batch','-Dstorymodel4s.grakern.build=/private/tmp/storymodel4s-film-consumer-20260919-9zqdg50z/grakern',*tasks];started=time.time()
